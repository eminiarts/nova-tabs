...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__components_DetailTabs__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__components_DetailTabs___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__components_DetailTabs__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__components_FormTabs__ = __webpack_require__(12);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__components_FormTabs___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__components_FormTabs__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_vue2_perfect_scrollbar__ = __webpack_require__(36);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_vue2_perfect_scrollbar___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2_vue2_perfect_scrollbar__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_vue2_perfect_scrollbar_dist_vue2_perfect_scrollbar_css__ = __webpack_require__(37);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_vue2_perfect_scrollbar_dist_vue2_perfect_scrollbar_css___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3_vue2_perfect_scrollbar_dist_vue2_perfect_scrollbar_css__);
...
Nova.booting(function (Vue) {
    Vue.use(__WEBPACK_IMPORTED_MODULE_2_vue2_perfect_scrollbar___default.a);
    Vue.component('detail-tabs', __WEBPACK_IMPORTED_MODULE_0__components_DetailTabs___default.a);
    Vue.component('form-tabs', __WEBPACK_IMPORTED_MODULE_1__components_FormTabs___default.a);
});
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_laravel_nova_src_mixins_BehavesAsPanel__ = __webpack_require__(10);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    mixins: [__WEBPACK_IMPORTED_MODULE_1_laravel_nova_src_mixins_BehavesAsPanel__["a" /* default */]],
    data: function data() {
        return {
            tabs: null,
            activeTab: '',
    ...
    computed: {
        activeTabHasSearch: function activeTabHasSearch() {
            ...
            return tab.fields.some(function (field) {
                if (field.resourceName === 'action-events') {
                    return false;
                }

                return ['has-many-field', 'belongs-to-many-field', 'morph-many-field', 'morph-to-many-field'].includes(field.component);
            });
        },
        maxTabsDisplayWidth: function maxTabsDisplayWidth() {
            if (!this.initialized) {
                return '100%';
            }
    ...
    mounted: function mounted() {
        ...
        if (!_.isUndefined(this.$route.query.tab) && !_.isUndefined(tabs[this.$route.query.tab])) {
            this.$nextTick(function () {
                var selectedTabRef = _this.$refs['tab-' + _this.slugify(_this.$route.query.tab)];

                if (selectedTabRef && selectedTabRef.length > 0) {
                    _this.$refs.scroll.$el.scrollLeft = selectedTabRef[0].offsetLeft;
                }
            });
    ...
    methods: {
        ...
        handleTabClick: function handleTabClick(tab) {
            var cur = this.$router.currentRoute.query;
        ...
        setActiveTabSearchWidth: function () {
            ...
            function setActiveTabSearchWidth() {
                return _ref.apply(this, arguments);
            }

            return setActiveTabSearchWidth;
        }(),
        getSearchBar: function () {
            var _ref2 = _asyncToGenerator( /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator___default.a.mark(function _callee2() {
                var attempts, searchBarSizes, selector, wait, isSettled, element;
                    ...
                    while (1) {
                        switch (_context2.prev = _context2.next) {
                            case 0:
                                attempts = 0;
                                searchBarSizes = [];
                                selector = '[label="' + this.activeTab + '"] .relative .flex';
                                ...
                                isSettled = function isSettled() {
                                    return searchBarSizes.length >= 3 && searchBarSizes.slice(-3).reduce(function (sizes, size) {
        ...
        [
          _c(
            "div",
            {
              ...
              style: { maxWidth: _vm.maxTabsDisplayWidth }
            },
            [
              _c(
                "perfect-scrollbar",
                { ref: "scroll", attrs: { options: _vm.scrollOptions } },
                [
                  _c(
                    "div",
                    { staticClass: "tabs flex flex-row" },
                    _vm._l(_vm.tabs, function(tab, key) {
                      return _c(
                        "button",
                        {
                          key: key,
                          ref: "tab-" + _vm.slugify(tab.name),
                          refInFor: true,
                          staticClass:
...
var render = function() {
  ...
  return _c("div", [
    ...
    _c(
      "div",
      { staticClass: "relationship-tabs-panel card w-full" },
      [
        _c(
          "div",
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../../css-loader/index.js!./vue2-perfect-scrollbar.css", function() {
			var newContent = require("!!../../css-loader/index.js!./vue2-perfect-scrollbar.css");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
