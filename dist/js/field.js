...
"use strict";
/* harmony export (immutable) */ __webpack_exports__["a"] = changeActiveTab;
var _extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; };

function changeActiveTab(router, tabName) {
...
Nova.booting(function (Vue) {
    Vue.component('detail-tabs', __webpack_require__(6));
    Vue.component('form-tabs', __webpack_require__(13));
});
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_laravel_nova_src_mixins_BehavesAsPanel__ = __webpack_require__(11);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__util_tab_updater__ = __webpack_require__(3);
//
//
//
//
        ...
        var tabs = this.tabs = this.panel.fields.reduce(function (tabs, field) {
            if (!(field.tabSlug in tabs)) {
                tabs[field.tabSlug] = {
                    ...
                    fields: [],
                    tabInfo: _this.panel.tabInfo[field.tabSlug]
                };
            }
    ...
    methods: {
        ...
        handleTabClick: function handleTabClick(tab) {
            ...
            if (updateUri && (!query || query.tab !== tab.tabInfo.slug)) {
                Object(__WEBPACK_IMPORTED_MODULE_1__util_tab_updater__["a" /* changeActiveTab */])(this.$router, tab.tabInfo.slug);
            }
        },
        ...
        getTabClass: function getTabClass(tab) {
            var baseClasses = [this.activeTab === tab.tabInfo.slug ? 'text-grey-black font-bold border-primary' : 'text-grey font-semibold border-40'];

            return baseClasses.concat(tab.tabInfo.tabClass);
        },
        getBodyClass: function getBodyClass(tab) {
            var baseClasses = [!tab.listable ? 'px-6 py-3' : ''];
                ...
                directives: [
                  {
                    name: "show",
                    rawName: "v-show",
                    value: tab.tabInfo.slug === _vm.activeTab,
                    expression: "tab.tabInfo.slug === activeTab"
                  }
                ],
                key: "related-tabs-fields" + index,
                ref: _vm.getTabRefName(tab),
                refInFor: true,
                class: [
        ...
        */
        ...
        handleTabClick: function handleTabClick(tab) {
            ...
            if (!cur || cur.tab !== tab.name) {
                Object(__WEBPACK_IMPORTED_MODULE_1__util_tab_updater__["a" /* changeActiveTab */])(this.$router, tab.name);
            }
        ...
        refreshCodeFields: function refreshCodeFields() {
            this.$refs.fields.filter(function (field) {
                return 'codemirror' in field;
            }).forEach(function (field) {
                return field.codemirror.refresh();
            });
        }
    }
});
